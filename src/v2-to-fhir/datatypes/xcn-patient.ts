/**
 * HL7v2 XCN to FHIR Patient Mapping
 * Based on: HL7 Data Type - FHIR R4_ XCN[Patient]
 */
 ...
 *
 * Note: For XCN[Patient], XCN.7 (Degree) is mapped to name.suffix[2] instead of qualification
 */
...
/**
 * Convert HL7v2 XCN (Extended Composite ID Number and Name for Persons) to FHIR Patient
 *
 * Mapping:
 ...
 * - XCN.5          -> name.suffix[0]
 * - XCN.6          -> name.prefix
 * - XCN.7          -> name.suffix[1] (NOTE: Different from Practitioner - no qualification)
...
/**
 * Convert array of XCN to array of Patient
 */
