...
import type {
  ...
  TaskInput,
  TaskOutput,
} from "../fhir/hl7-fhir-r4-core/Task";
  ...
  const inputs: TaskInput[] = [
    {
      ...
      valueString: params.sender.sendingApplication,
    },
    {
      type: { text: "Sending facility" },
      valueString: params.sender.sendingFacility,
    },
