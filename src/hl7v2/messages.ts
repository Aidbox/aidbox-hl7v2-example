...
/**
 * Builder for BAR_P01 PROCEDURE group
 */
export class BAR_P01_PROCEDUREBuilder {
  ...
  pr1(segment: HL7v2Segment | PR1Builder | ((builder: PR1Builder) => PR1Builder)): this {
    if (typeof segment === "function") {
      this.group.pr1 = segment(new PR1Builder()).build();
    } else if (segment instanceof PR1Builder) {
      this.group.pr1 = segment.build();
    } else {
      this.group.pr1 = segment;
    }
    return this;
  }
  ...
  addROL(segment: HL7v2Segment | ROLBuilder | ((builder: ROLBuilder) => ROLBuilder)): this {
    ...
    if (typeof segment === "function") {
      seg = segment(new ROLBuilder()).build();
    } else if (segment instanceof ROLBuilder) {
      seg = segment.build();
    } else {
      seg = segment;
    }
...
/**
 * Builder for BAR_P01 INSURANCE group
 */
export class BAR_P01_INSURANCEBuilder {
  ...
  in1(segment: HL7v2Segment | IN1Builder | ((builder: IN1Builder) => IN1Builder)): this {
    if (typeof segment === "function") {
      this.group.in1 = segment(new IN1Builder()).build();
    } else if (segment instanceof IN1Builder) {
      this.group.in1 = segment.build();
    } else {
      this.group.in1 = segment;
    }
    return this;
  }
  ...
  in2(segment: HL7v2Segment | IN2Builder | ((builder: IN2Builder) => IN2Builder)): this {
    if (typeof segment === "function") {
      this.group.in2 = segment(new IN2Builder()).build();
    } else if (segment instanceof IN2Builder) {
      this.group.in2 = segment.build();
    } else {
      this.group.in2 = segment;
    }
    return this;
  }
  ...
  addIN3(segment: HL7v2Segment | IN3Builder | ((builder: IN3Builder) => IN3Builder)): this {
    let seg: HL7v2Segment;
    if (typeof segment === "function") {
      seg = segment(new IN3Builder()).build();
    } else if (segment instanceof IN3Builder) {
      seg = segment.build();
    } else {
      seg = segment;
    }
...
/**
 * Builder for BAR_P01 VISIT group
 */
export class BAR_P01_VISITBuilder {
  ...
  pv1(segment: HL7v2Segment | PV1Builder | ((builder: PV1Builder) => PV1Builder)): this {
    if (typeof segment === "function") {
      this.group.pv1 = segment(new PV1Builder()).build();
    } else if (segment instanceof PV1Builder) {
      this.group.pv1 = segment.build();
    } else {
      this.group.pv1 = segment;
    }
    return this;
  }
  ...
  pv2(segment: HL7v2Segment | PV2Builder | ((builder: PV2Builder) => PV2Builder)): this {
    if (typeof segment === "function") {
      this.group.pv2 = segment(new PV2Builder()).build();
    } else if (segment instanceof PV2Builder) {
      this.group.pv2 = segment.build();
    } else {
      this.group.pv2 = segment;
    }
    return this;
  }
  ...
  addDB1(segment: HL7v2Segment | DB1Builder | ((builder: DB1Builder) => DB1Builder)): this {
    let seg: HL7v2Segment;
    if (typeof segment === "function") {
      seg = segment(new DB1Builder()).build();
    } else if (segment instanceof DB1Builder) {
      seg = segment.build();
    } else {
      seg = segment;
    }
  ...
  addOBX(segment: HL7v2Segment | OBXBuilder | ((builder: OBXBuilder) => OBXBuilder)): this {
    let seg: HL7v2Segment;
    if (typeof segment === "function") {
      seg = segment(new OBXBuilder()).build();
    } else if (segment instanceof OBXBuilder) {
      seg = segment.build();
    } else {
      seg = segment;
    }
  ...
  addAL1(segment: HL7v2Segment | AL1Builder | ((builder: AL1Builder) => AL1Builder)): this {
    let seg: HL7v2Segment;
    if (typeof segment === "function") {
      seg = segment(new AL1Builder()).build();
    } else if (segment instanceof AL1Builder) {
      seg = segment.build();
    } else {
      seg = segment;
    }
  ...
  addDG1(segment: HL7v2Segment | DG1Builder | ((builder: DG1Builder) => DG1Builder)): this {
    let seg: HL7v2Segment;
    if (typeof segment === "function") {
      seg = segment(new DG1Builder()).build();
    } else if (segment instanceof DG1Builder) {
      seg = segment.build();
    } else {
      seg = segment;
    }
  ...
  drg(segment: HL7v2Segment | DRGBuilder | ((builder: DRGBuilder) => DRGBuilder)): this {
    if (typeof segment === "function") {
      this.group.drg = segment(new DRGBuilder()).build();
    } else if (segment instanceof DRGBuilder) {
      this.group.drg = segment.build();
    } else {
      this.group.drg = segment;
    }
    return this;
  }
  ...
  addPROCEDURE(group: BAR_P01_PROCEDURE | BAR_P01_PROCEDUREBuilder | ((builder: BAR_P01_PROCEDUREBuilder) => BAR_P01_PROCEDUREBuilder)): this {
    ...
    if (typeof group === "function") {
      g = group(new BAR_P01_PROCEDUREBuilder()).build();
    } else if (group instanceof BAR_P01_PROCEDUREBuilder) {
      g = group.build();
    } else {
      g = group;
    }
  ...
  addGT1(segment: HL7v2Segment | GT1Builder | ((builder: GT1Builder) => GT1Builder)): this {
    let seg: HL7v2Segment;
    if (typeof segment === "function") {
      seg = segment(new GT1Builder()).build();
    } else if (segment instanceof GT1Builder) {
      seg = segment.build();
    } else {
      seg = segment;
    }
  ...
  addNK1(segment: HL7v2Segment | NK1Builder | ((builder: NK1Builder) => NK1Builder)): this {
    let seg: HL7v2Segment;
    if (typeof segment === "function") {
      seg = segment(new NK1Builder()).build();
    } else if (segment instanceof NK1Builder) {
      seg = segment.build();
    } else {
      seg = segment;
    }
  ...
  addINSURANCE(group: BAR_P01_INSURANCE | BAR_P01_INSURANCEBuilder | ((builder: BAR_P01_INSURANCEBuilder) => BAR_P01_INSURANCEBuilder)): this {
    ...
    if (typeof group === "function") {
      g = group(new BAR_P01_INSURANCEBuilder()).build();
    } else if (group instanceof BAR_P01_INSURANCEBuilder) {
      g = group.build();
    } else {
      g = group;
    }
  ...
  acc(segment: HL7v2Segment | ACCBuilder | ((builder: ACCBuilder) => ACCBuilder)): this {
    if (typeof segment === "function") {
      this.group.acc = segment(new ACCBuilder()).build();
    } else if (segment instanceof ACCBuilder) {
      this.group.acc = segment.build();
    } else {
      this.group.acc = segment;
    }
    return this;
  }
  ...
  ub1(segment: HL7v2Segment | UB1Builder | ((builder: UB1Builder) => UB1Builder)): this {
    if (typeof segment === "function") {
      this.group.ub1 = segment(new UB1Builder()).build();
    } else if (segment instanceof UB1Builder) {
      this.group.ub1 = segment.build();
    } else {
      this.group.ub1 = segment;
    }
    return this;
  }
  ...
  ub2(segment: HL7v2Segment | UB2Builder | ((builder: UB2Builder) => UB2Builder)): this {
    if (typeof segment === "function") {
      this.group.ub2 = segment(new UB2Builder()).build();
    } else if (segment instanceof UB2Builder) {
      this.group.ub2 = segment.build();
    } else {
      this.group.ub2 = segment;
    }
    return this;
  }
...
/**
 * Type-safe builder for BAR_P01 messages
 */
export class BAR_P01Builder {
  ...
  msh(segment: HL7v2Segment | MSHBuilder | ((builder: MSHBuilder) => MSHBuilder)): this {
    if (typeof segment === "function") {
      this.msg.msh = segment(new MSHBuilder()).build();
    } else if (segment instanceof MSHBuilder) {
      this.msg.msh = segment.build();
    } else {
      this.msg.msh = segment;
    }
    return this;
  }
  ...
  addSFT(segment: HL7v2Segment | SFTBuilder | ((builder: SFTBuilder) => SFTBuilder)): this {
    let seg: HL7v2Segment;
    if (typeof segment === "function") {
      seg = segment(new SFTBuilder()).build();
    } else if (segment instanceof SFTBuilder) {
      seg = segment.build();
    } else {
      seg = segment;
    }
  ...
  evn(segment: HL7v2Segment | EVNBuilder | ((builder: EVNBuilder) => EVNBuilder)): this {
    if (typeof segment === "function") {
      this.msg.evn = segment(new EVNBuilder()).build();
    } else if (segment instanceof EVNBuilder) {
      this.msg.evn = segment.build();
    } else {
      this.msg.evn = segment;
    }
    return this;
  }
  ...
  pid(segment: HL7v2Segment | PIDBuilder | ((builder: PIDBuilder) => PIDBuilder)): this {
    if (typeof segment === "function") {
      this.msg.pid = segment(new PIDBuilder()).build();
    } else if (segment instanceof PIDBuilder) {
      this.msg.pid = segment.build();
    } else {
      this.msg.pid = segment;
    }
    return this;
  }
  ...
  pd1(segment: HL7v2Segment | PD1Builder | ((builder: PD1Builder) => PD1Builder)): this {
    if (typeof segment === "function") {
      this.msg.pd1 = segment(new PD1Builder()).build();
    } else if (segment instanceof PD1Builder) {
      this.msg.pd1 = segment.build();
    } else {
      this.msg.pd1 = segment;
    }
    return this;
  }
  ...
  addVISIT(group: BAR_P01_VISIT | BAR_P01_VISITBuilder | ((builder: BAR_P01_VISITBuilder) => BAR_P01_VISITBuilder)): this {
    let g: BAR_P01_VISIT;
    if (typeof group === "function") {
      g = group(new BAR_P01_VISITBuilder()).build();
    } else if (group instanceof BAR_P01_VISITBuilder) {
      g = group.build();
    } else {
      g = group;
    }
  ...
  /**
   * Build the message as a flat array of segments (HL7v2Message)
  ...
  build(): HL7v2Message {
    ...
    if (this.msg.rol) {
      for (const seg of this.msg.rol) {
        segments.push(seg);
      }
    }
    if (this.msg.visit) {
      for (const group of this.msg.visit) {
        if (group.pv1) segments.push(group.pv1);
        if (group.pv2) segments.push(group.pv2);
        if (group.rol) {
          for (const seg of group.rol) {
            segments.push(seg);
          }
        }
        if (group.db1) {
          for (const seg of group.db1) {
            segments.push(seg);
          }
        }
        if (group.obx) {
          for (const seg of group.obx) {
            segments.push(seg);
          }
        }
        if (group.al1) {
          for (const seg of group.al1) {
            segments.push(seg);
          }
        }
        if (group.dg1) {
          for (const seg of group.dg1) {
            segments.push(seg);
          }
        }
        if (group.drg) segments.push(group.drg);
        if (group.procedure) {
          for (const subgroup of group.procedure) {
            if (subgroup.pr1) segments.push(subgroup.pr1);
            if (subgroup.rol) {
              for (const seg of subgroup.rol) {
                segments.push(seg);
              }
            }
          }
        ...
        if (group.gt1) {
          for (const seg of group.gt1) {
            segments.push(seg);
          }
        }
        if (group.nk1) {
          for (const seg of group.nk1) {
            segments.push(seg);
          }
        }
        if (group.insurance) {
          for (const subgroup of group.insurance) {
            if (subgroup.in1) segments.push(subgroup.in1);
            if (subgroup.in2) segments.push(subgroup.in2);
            if (subgroup.in3) {
              for (const seg of subgroup.in3) {
                segments.push(seg);
              }
            }
            if (subgroup.rol) {
  ...
  /** Get the structured message object */
  toStructured(): BAR_P01_Message {
    return this.msg as BAR_P01_Message;
  }
}
