  ...
  routes: {
    ...
    "/api/mapping/tasks/:id/resolve": {
      POST: async (req) => {
        ...
        const taskId = pathParts[pathParts.length - 2]; // /api/mapping/tasks/:id/resolve
        ...
        if (!loincCode) {
          return new Response("LOINC code is required", { status: 400 });
        }
